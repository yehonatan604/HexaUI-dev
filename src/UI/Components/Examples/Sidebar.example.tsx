...
const SidebarExample = () => {
  return (
    <Sidebar>
      ...
      <Sidebar.Seperator />
      <Sidebar.Item icon={<Gi3dMeeple />}>Menu Item 5</Sidebar.Item>
      <Sidebar.Item icon={<Gi3dMeeple />}>Menu Item 6</Sidebar.Item>
      <Sidebar.Item icon={<Gi3dMeeple />}>Menu Item 7</Sidebar.Item>
      <Sidebar.Seperator />
